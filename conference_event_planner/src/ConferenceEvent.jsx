...
import mealsItems from "./store.js";
                ...
                {!showItems ? (
                    <div className="items-information">
                        ...
                        <div id="addons" className="venue_container container_main">
                            ...
                            <div className="addons_selection">{avItems.map((item, index) => (
                        ...
                        <div id="meals" className="venue_container container_main">
                            ...
                            <div className="input-container venue_selection">    <label htmlFor="numberOfPeople"><h3>Number of People:</h3></label>
